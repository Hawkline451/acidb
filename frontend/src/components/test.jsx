  ...
  const [formState, setFormState] = useState(
    {
      ...
      gc_percentage_gte: '',
      gc_percentage_lte: '',
      gen_contamination_gte: '',
      gen_contamination_lte: '',
      gen_completeness_gte: '',
      gen_completeness_lte: '',
      state: '',
      access_src: '',
      access_id: '',
      bioproject: '',
                  ...
                  <Table >
                    <TableBody>
                      <TableRow >
                        ...
                        <TableCell style={{ borderStyle: 'none' }} align="left">
                          <TextField variant='outlined'
                            name='gen_contamination_gte'
                            type="text"
                            label="min value"
                            value={formState.gen_contamination_gte}
                            onChange={event => handleChange(event.target)}
                          />
                          <TextField variant='outlined'
                      ...
                      <TableRow >
                        ...
                        <TableCell style={{ borderStyle: 'none' }} align="left">
                          ...
                          />
                          <TextField variant='outlined'
                            name='gen_completeness_lte'
                            type="text"
                            label="max value"
                            value={formState.gen_completeness_lte}
                            onChange={event => handleChange(event.target)}
                            style={{ marginTop: 5 }}
                          />
                        </TableCell>
